...
public class EditorDeTexto {
    public static void main(String[] args) {
        // Criando a pilha para armazenar as palavras digitadas
        Stack<String> pilhaDePalavras = new Stack<>();

        // Simulando as palavras digitadas
        pilhaDePalavras.push("Estruturas");
        pilhaDePalavras.push("de");
        pilhaDePalavras.push("Dados");

        // Simulando desfazer (remover do topo da pilha)
        String removida1 = pilhaDePalavras.pop();
        System.out.println("Palavra removida (desfazer): " + removida1);

        String removida2 = pilhaDePalavras.pop();
        System.out.println("Palavra removida (desfazer): " + removida2);

        // Exibindo o conteúdo atual da pilha
        System.out.println("Conteúdo atual: " + pilhaDePalavras);
    }
}


Palavra removida (desfazer): Dados
Palavra removida (desfazer): de
Conteúdo atual: [Estruturas]
